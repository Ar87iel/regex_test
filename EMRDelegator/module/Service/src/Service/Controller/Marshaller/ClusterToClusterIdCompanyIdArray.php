...
class ClusterToClusterIdCompanyIdArray implements MarshallerInterface, ServiceLocatorAwareInterface
{
    /**
     ...
     * @return array[]
     */
    protected function marshalClusterIds($clusterModels)
    {
        $clusters = array();
    ...
    private function marshalClusterId(ClusterModel $clusterModel)
    {
        ...
        $marshaller = $this->serviceLocator->get('Service\Controller\Marshaller\CompanyToCompanyIdArray');
